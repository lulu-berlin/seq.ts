...
var Seq = /** @class */ (function () {
    ...
    Seq.prototype.concat = function () {
        var items = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            items[_i] = arguments[_i];
        }
        return Seq.concat.apply(Seq, tslib_1.__spread([this], items));
    };
    Seq.concat = function () {
        var items = [];
        for (var _i = 0; _i < arguments.length; _i++) {
        ...
        return new Seq((_a = {},
            _a[Symbol.iterator] = function () {
                ...
                var iterator = nextItem instanceof Seq ? nextItem : Seq.of(nextItem);
                var next = function () {
    ...
    Seq.init = function (count, initializer) {
        var seq = Seq.from(Array(count).keys());
        return initializer ? seq.map(initializer) : seq;
    };
    Seq.initInfinite = function (initializer) {
        var seq = new Seq((_a = {},
            _a[Symbol.iterator] = function () {
                var index = 0;
    ...
    Seq.zip = function (source1, source2) {
        return new Seq((_a = {},
            _a[Symbol.iterator] = function () {
                var iterator1 = source1[Symbol.iterator]();
                var iterator2 = source2[Symbol.iterator]();
                return {
                    next: function () {
